...
import { Database, Trophy, Gavel } from "lucide-react";
...
export default function ImportData() {
  ...
  // Admin-only — redirect any non-admin immediately
    ...
    <div className="p-4 lg:p-8 max-w-3xl mx-auto space-y-12">
        ...
        <div className="flex items-start gap-3 pb-3 border-b">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Sube el .xlsx de inscripciones de una competición. Vincula a una competición concreta antes de importar.
      ...
      <section className="space-y-4">
        <div className="flex items-start gap-3 pb-3 border-b">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Sube el documento de resultados de una jornada. El ranking se recalcula automáticamente.
              No sobreescribe jornadas ya importadas sin confirmación explícita.
            </p>
          </div>
        </div>
        <ImportLigaJornada />
      ...
      <section className="space-y-4">
        <div className="flex items-start gap-3 pb-3 border-b">
          ...
          <div>
            <h2 className="text-lg font-semibold flex items-center gap-2">
              <Gavel className="w-5 h-5 text-primary" /> Subir acta de puntuaciones de jueces
            </h2>
            <p className="text-xs text-muted-foreground mt-0.5">
              Asigna el documento a una escuela y competición. Solo esa escuela lo verá en su portal.
              Las puntuaciones extraídas se usan como criterio de desempate en el ranking de liga.
            </p>
          </div>
        </div>
        <ImportActaJueces />
